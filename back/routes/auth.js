...
authRouter.post('/login', async (req, res) => {
    ...
    const token = jwt.sign({user}, "Stack", {expiresIn : "10s"}, process.env.SECRET) // create the token with key 'user' and sign the jwt. SECRET is an additional safety feature. This SECRET is created by JWT and sent to the user. it stays encrypted al
